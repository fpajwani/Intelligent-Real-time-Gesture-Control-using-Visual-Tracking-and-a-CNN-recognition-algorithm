# -*- coding: utf-8 -*-
"""
Created on Thu Nov  26 01:01:43 2020
...
banner =  '''\nSelect one of the Options:
    ...
    2- Train the model (Image samples for training under .\imgfolder)
    3- Exit	
    '''
...
# It simply tries to remove the background content by taking a image of the 
...
def Main():
    ...
    while(True):
        ...
        cv2.putText(frame,'Different Modes:',(fx,fy), font, 0.7,(0,255,0),2,1)
        ...
        cv2.putText(frame,'g - Toggle Prediction Mode (On different window)',(fx,fy + 3*fh), font, size,(0,255,0),1,1)
        cv2.putText(frame,'q - Toggle Quiet Mode',(fx,fy + 4*fh), font, size,(0,255,0),1,1)
        cv2.putText(frame,'n - To enter name of new gesture folder (Console Screen)',(fx,fy + 5*fh), font, size,(0,255,0),1,1)
        cv2.putText(frame,'s - To start capturing new gestures for training (Wait for few seconds)',(fx,fy + 6*fh), font, size,(0,255,0),1,1)
